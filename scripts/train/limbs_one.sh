...
--display_freq=500 --use_rec=0 --point_line=1 --use_bank=0 --par_weight=1 --limb_one=1 \
--continue_train --save_latest_freq=20000   --save_iters_freq=20000  --optim 'Adam'  --niter=200000  --ker_size=3 \
--checkpoints_dir '/apdcephfs/private_jiaxianchen/PISE_out/11_23_limbs_one' >> /apdcephfs/private_jiaxianchen/PISE_out/11_23_limbs_one/out.txt 
exit
