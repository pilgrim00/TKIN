...
class Newpar(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.net_G = network.define_g(opt,filename='generator_newpar',image_nc=opt.image_nc, structure_nc=opt.structure_nc, ngf=64,
    ...
    def test(self):
        ...
        self.img_gen, self.loss_reg,self.par2_= self.net_G(self.input_P1, self.input_P2,
    ...
    def forward(self):
        ...
        if self.opt.use_rec==1:
            self.img_gen, self.loss_reg,self.img_orig,self.par2__= self.net_G(self.input_P1, self.input_P2,
                                                                    self.input_BP1, self.input_BP2, self.input_SPL1, self.input_SPL2)
        else:
            self.img_gen, self.loss_reg,self.par2_= self.net_G(self.input_P1, self.input_P2,
                                                                    self.input_BP1, self.input_BP2, self.input_SPL1, self.input_SPL2)
    ...
    def backward_G(self):
        ...
        self.loss_par1 = self.L1loss(self.par2_, self.input_SPL2)*100    
