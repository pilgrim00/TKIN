...
class PoseGenerator(BaseNetwork):
    def __init__(self, image_nc=3, structure_nc=18, output_nc=3, ngf=64, norm='instance', 
                ...
                use_rec=None,ker_size=5,patch_dec=None,use_bank=None,parnet_pise=0):
        ...
        if parnet_pise==1:
            self.parnet=ParsingNet(input_nc=20+20+8, output_nc=8)
        else:
            self.parnet=ParUNet(input_nc=20+20+8, output_nc=8)
