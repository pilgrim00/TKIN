...
class PoseGenerator(BaseNetwork):
    def __init__(self, image_nc=3, structure_nc=18, output_nc=3, ngf=64, norm='instance', 
                ...
                use_rec=None,ker_size=5,patch_dec=None,use_bank=False):
        ...
        self.parnet=ParUNet(input_nc=6+8, output_nc=8)
    ...
    def forward(self, img1, img2, pose1, pose2, par1, par2):
        ...
        par1_=self.parnet(torch.cat([pose2,pose1,par2],dim=1))
        #visualize_features(pose2,'pose2')
        #visualize_features(par2_,'par_fake_thre_k5_bank')
        #visualize_features(par2,'par_true')
        #exit()
        ...
        if self.use_rec==1:
            ...
            return img_gen, loss_reg,img_orig,par2_,par1_
