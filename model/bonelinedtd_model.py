...
class Bonelinedtd(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = [ 'app_gen','content_gen', 'style_gen',
                           'ad_gen', 'dis_img_gen','dis_img_gen_dtd','par','par1']     
        ...
        self.visual_names = ['input_P1','input_P2','img2_dtd','img_gen','img_dtd_gen','par2_','input_SPL2']
        self.model_names = ['G','D','D_dtd']
        self.FloatTensor = torch.cuda.FloatTensor if len(self.gpu_ids)>0 \
            else torch.FloatTensor

        # define the generator
        self.net_G = network.define_g(opt,filename='generator_bonelinedtd',image_nc=opt.image_nc, structure_nc=opt.structure_nc, ngf=64,
    ...
    def set_input(self, input):
        ...
        label_P1,label_P2=input['label_P1'],input['label_P2']
    ...
    def test(self):
        ...
        self.img_gen, self.loss_reg,self.img_dtd_gen,_,_ = self.net_G(self.input_P1, self.input_P2,
    ...
    def forward(self):
        ...
        self.img_gen, self.loss_reg,self.img_dtd_gen,self.par2_,self.par1_ = self.net_G(self.input_P1, self.input_P2,
                                                        self.input_BP1, self.input_BP2, self.input_SPL1, self.input_SPL2,
                                                        self.input_dtd,self.img2_dtd)
