...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--epochs', type=int, default=50, help='# number of epochs with initial learning rate')
        parser.add_argument('--niter', type=int, default=5000000, help='# of iter with initial learning rate')
        parser.add_argument('--niter_decay', type=int, default=1, help='# of iter to decay learning rate to zero')
        ...
        parser.add_argument('--save_iters_freq', type=int, default=20000, help='frequency of saving checkpoints at the end of epochs')
